...
SWIFT_MODULE_NAMESPACE_PUSH("InputMask")
...
SWIFT_CLASS("_TtC9InputMask23MaskedTextFieldDelegate")
@interface MaskedTextFieldDelegate : NSObject <UITextFieldDelegate>
@property (nonatomic, copy) NSString * _Nonnull maskFormat;
@property (nonatomic) BOOL autocomplete;
@property (nonatomic) BOOL autocompleteOnFocus;
@property (nonatomic, weak) id <MaskedTextFieldDelegateListener> _Nullable listener;
- (nonnull instancetype)initWithFormat:(NSString * _Nonnull)format OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init;
- (void)putWithText:(NSString * _Nonnull)text into:(UITextField * _Nonnull)field;
/// Maximal length of the text inside the field.
///
/// returns:
/// Total available count of mandatory and optional characters inside the text field.
- (NSString * _Nonnull)placeholder SWIFT_WARN_UNUSED_RESULT;
/// Minimal length of the text inside the field to fill all mandatory characters in the mask.
///
/// returns:
/// Minimal satisfying count of characters inside the text field.
- (NSInteger)acceptableTextLength SWIFT_WARN_UNUSED_RESULT;
/// Maximal length of the text inside the field.
///
/// returns:
/// Total available count of mandatory and optional characters inside the text field.
- (NSInteger)totalTextLength SWIFT_WARN_UNUSED_RESULT;
/// Minimal length of the extracted value with all mandatory characters filled.
///
/// returns:
/// Minimal satisfying count of characters in extracted value.
- (NSInteger)acceptableValueLength SWIFT_WARN_UNUSED_RESULT;
/// Maximal length of the extracted value.
///
/// returns:
/// Total available count of mandatory and optional characters for extracted value.
- (NSInteger)totalValueLength SWIFT_WARN_UNUSED_RESULT;
...
@interface MaskedTextFieldDelegate (SWIFT_EXTENSION(InputMask))
...
SWIFT_PROTOCOL("_TtP9InputMask31MaskedTextFieldDelegateListener_")
...
/// Might be used as a decorator, which forwards UITextFieldDelegate calls to its own listener.
SWIFT_CLASS("_TtC9InputMask25PolyMaskTextFieldDelegate")
@interface PolyMaskTextFieldDelegate : MaskedTextFieldDelegate
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull affineFormats;
- (nonnull instancetype)initWithPrimaryFormat:(NSString * _Nonnull)primaryFormat affineFormats:(NSArray<NSString *> * _Nonnull)affineFormats OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFormat:(NSString * _Nonnull)format OBJC_DESIGNATED_INITIALIZER;
- (void)putWithText:(NSString * _Nonnull)text into:(UITextField * _Nonnull)field;
@property (nonatomic, readonly, copy) NSString * _Nonnull debugDescription;
@end
...
SWIFT_CLASS("_TtC9InputMask6RNMask")
@interface RNMask : NSObject
+ (NSString * _Nonnull)maskValueWithText:(NSString * _Nonnull)text format:(NSString * _Nonnull)format SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)unmaskValueWithText:(NSString * _Nonnull)text format:(NSString * _Nonnull)format SWIFT_WARN_UNUSED_RESULT;
